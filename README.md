...
- `maxLoggedBattlesPerOutcome` retains at most the configured number of logged player wins, opponent wins, and draws. It takes precedence over `maxLoggedBattles` and discards excess battle logs immediately after each battle to keep memory bounded.
