...
export class SimulationRunner {
  ...
  constructor(public readonly runtime: EngineContext,
    ...
    this.player = new Player(runtime, this.logService, abilityService, gameService);
    this.opponent = new Player(runtime, this.logService, abilityService, gameService);
    this.opponent.isOpponent = true;
    this.gameService.init(this.player, this.opponent);

    this.abilityEngine = new AbilityEngine(runtime,
      this.logService,
      this.gameService,
      this.abilityService,
      this.toyService,
    ...
    this.eventProcessor = new EventProcessor(runtime, context);
  }
  ...
  public run(
    ...
    this.runtime.random.begin(config.seed, config.captureRandomDraws, config.randomDrawOverrides);
    let randomSessionResult: ReturnType<EngineContext['random']['finishRandomDecisionSession']>;
    ...
    this.runtime.random.startRandomDecisionSession({
    ...
    try {
      ...
      randomSessionResult = this.runtime.random.finishRandomDecisionSession();
    }
    this.runtime.random.assertReplayValid();
