...
export class MarineIguana extends Pet {
  ...
  initAbilities(): void {
    this.addAbility(new MarineIguanaAbility(this.runtime, this, this.logService));
    super.initAbilities();
  }
...
export class MarineIguanaAbility extends Ability {
  ...
  private executeAbility(context: AbilityContext): void {
    ...
    attackingFriend.givePetEquipment(new Melon(this.runtime));
  ...
  copy(newOwner: Pet): MarineIguanaAbility {
    return new MarineIguanaAbility(this.runtime, newOwner, this.logService);
  }
}
