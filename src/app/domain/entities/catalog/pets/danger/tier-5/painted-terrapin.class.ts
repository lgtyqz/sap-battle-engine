...
export class PaintedTerrapin extends Pet {
  ...
  initAbilities(): void {
    this.addAbility(new PaintedTerrapinAbility(this.runtime, this, this.logService));
    super.initAbilities();
  }
...
export class PaintedTerrapinAbility extends Ability {
  ...
  private executeAbility(context: AbilityContext): void {
    ...
    for (let targetPet of targets) {
      ...
      targetPet.givePetEquipment(new WhiteOkra(this.runtime));
    }
  ...
  copy(newOwner: Pet): PaintedTerrapinAbility {
    return new PaintedTerrapinAbility(this.runtime, newOwner, this.logService);
  }
}
