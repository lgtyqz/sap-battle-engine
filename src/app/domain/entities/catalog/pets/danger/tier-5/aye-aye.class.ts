...
export class AyeAye extends Pet {
  ...
  initAbilities(): void {
    this.addAbility(
      new AyeAyeAbility(this.runtime, this, this.logService, this.abilityService),
    );
    super.initAbilities();
  }
...
export class AyeAyeAbility extends Ability {
  ...
  private executeAbility(context: AbilityContext): void {
    ...
    for (let i = 0; i < 2; i++) {
      ...
      let lemur = new Lemur(this.runtime,
        this.logService,
        this.abilityService,
        owner.parent,
        lemurHealth,
  ...
  copy(newOwner: Pet): AyeAyeAbility {
    return new AyeAyeAbility(this.runtime, newOwner, this.logService, this.abilityService);
  }
}
