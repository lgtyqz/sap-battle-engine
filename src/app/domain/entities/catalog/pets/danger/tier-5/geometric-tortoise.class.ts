...
export class GeometricTortoise extends Pet {
  ...
  initAbilities(): void {
    this.addAbility(new GeometricTortoiseAbility(this.runtime, this, this.logService));
    super.initAbilities();
  }
...
export class GeometricTortoiseAbility extends Ability {
  ...
  copy(newOwner: Pet): GeometricTortoiseAbility {
    return new GeometricTortoiseAbility(this.runtime, newOwner, this.logService);
  }
}
