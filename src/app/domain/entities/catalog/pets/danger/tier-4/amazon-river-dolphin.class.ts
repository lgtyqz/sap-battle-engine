...
export class AmazonRiverDolphin extends Pet {
  ...
  initAbilities(): void {
    this.addAbility(new AmazonRiverDolphinAbility(this.runtime, this, this.logService));
    super.initAbilities();
  }
...
export class AmazonRiverDolphinAbility extends Ability {
  ...
  copy(newOwner: Pet): AmazonRiverDolphinAbility {
    return new AmazonRiverDolphinAbility(this.runtime, newOwner, this.logService);
  }
}
