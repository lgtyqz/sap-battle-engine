...
export class TaitaShrew extends Pet {
  ...
  initAbilities(): void {
    this.addAbility(
      new TaitaShrewAbility(this.runtime, this, this.logService, this.abilityService),
    );
    super.initAbilities();
  }
...
export class TaitaShrewAbility extends Ability {
  ...
  private executeAbility(context: AbilityContext): void {
    ...
    let weasel = new Weasel(this.runtime,
      this.logService,
      this.abilityService,
      owner.parent,
      target.health,
  ...
  copy(newOwner: Pet): TaitaShrewAbility {
    return new TaitaShrewAbility(this.runtime,
      newOwner,
      this.logService,
      this.abilityService,
    );
