...
export class TreeKangaroo extends Pet {
  ...
  initAbilities(): void {
    this.addAbility(new TreeKangarooAbility(this.runtime, this, this.logService));
    super.initAbilities();
  }
...
export class TreeKangarooAbility extends Ability {
  ...
  private executeAbility(context: AbilityContext): void {
    ...
    if (targetPet) {
      targetPet.givePetEquipment(new Silly(this.runtime));
  ...
  copy(newOwner: Pet): TreeKangarooAbility {
    return new TreeKangarooAbility(this.runtime, newOwner, this.logService);
  }
}
