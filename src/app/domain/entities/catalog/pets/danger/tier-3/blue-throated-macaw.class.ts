...
export class BlueThroatedMacaw extends Pet {
  ...
  health = 4;
  initAbilities(): void {
    this.addAbility(new BlueThroatedMacawAbility(this.runtime, this, this.logService));
    super.initAbilities();
  }
...
export class BlueThroatedMacawAbility extends Ability {
  ...
  copy(newOwner: Pet): BlueThroatedMacawAbility {
    return new BlueThroatedMacawAbility(this.runtime, newOwner, this.logService);
  }
}
