...
export class GreenSeaTurtle extends Pet {
  ...
  initAbilities(): void {
    this.addAbility(new GreenSeaTurtleAbility(this.runtime, this, this.logService));
    super.initAbilities();
  }
...
export class GreenSeaTurtleAbility extends Ability {
  ...
  private executeAbility(context: AbilityContext): void {
    ...
    for (let targetPet of targets) {
      targetPet.givePetEquipment(new Melon(this.runtime), owner.level);
  ...
  copy(newOwner: Pet): GreenSeaTurtleAbility {
    return new GreenSeaTurtleAbility(this.runtime, newOwner, this.logService);
  }
}
