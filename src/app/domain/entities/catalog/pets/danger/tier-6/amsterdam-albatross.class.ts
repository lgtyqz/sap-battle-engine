...
export class AmsterdamAlbatross extends Pet {
  ...
  initAbilities(): void {
    this.addAbility(new AmsterdamAlbatrossAbility(this.runtime, this, this.logService));
    super.initAbilities();
  }
...
export class AmsterdamAlbatrossAbility extends Ability {
  ...
  copy(newOwner: Pet): AmsterdamAlbatrossAbility {
    return new AmsterdamAlbatrossAbility(this.runtime, newOwner, this.logService);
  }
}
