...
export class IriomoteCat extends Pet {
  ...
  initAbilities(): void {
    this.addAbility(
      new IriomoteCatAbility(this.runtime, this, this.logService, this.petService),
    );
    super.initAbilities();
  }
...
export class IriomoteCatAbility extends Ability {
  ...
  copy(newOwner: Pet): IriomoteCatAbility {
    return new IriomoteCatAbility(this.runtime, newOwner, this.logService, this.petService);
  }
}
