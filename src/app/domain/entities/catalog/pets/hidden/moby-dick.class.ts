...
export class MobyDick extends Pet {
  ...
  initAbilities(): void {
    this.addAbility(
      new MobyDickAbility(this.runtime, this, this.logService, this.abilityService),
    );
    super.initAbilities();
  }
}
...
export class MobyDickAbility extends Ability {
  ...
  copy(newOwner: Pet): MobyDickAbility {
    return new MobyDickAbility(this.runtime, newOwner, this.logService, this.abilityService);
  }
}
