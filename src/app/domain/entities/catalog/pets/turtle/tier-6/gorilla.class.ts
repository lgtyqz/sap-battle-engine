...
export class Gorilla extends Pet {
  ...
  health = 10;
  initAbilities(): void {
    this.addAbility(new GorillaAbility(this.runtime, this, this.logService));
    super.initAbilities();
  }
...
export class GorillaAbility extends Ability {
  ...
  private executeAbility(context: AbilityContext): void {
    ...
    target.givePetEquipment(new Coconut(this.runtime));
  ...
  copy(newOwner: Pet): GorillaAbility {
    const newAbility = new GorillaAbility(this.runtime, newOwner, this.logService);
