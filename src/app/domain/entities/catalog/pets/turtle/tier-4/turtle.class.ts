...
export class Turtle extends Pet {
  ...
  health = 5;
  initAbilities(): void {
    this.addAbility(new TurtleAbility(this.runtime, this, this.logService));
    super.initAbilities();
  }
...
export class TurtleAbility extends Ability {
  ...
  private executeAbility(context: AbilityContext): void {
    ...
    for (let targetPet of targetsBehindResp.pets) {
      ...
      targetPet.givePetEquipment(new Melon(this.runtime));
    }
  ...
  copy(newOwner: Pet): TurtleAbility {
    return new TurtleAbility(this.runtime, newOwner, this.logService);
  }
}
