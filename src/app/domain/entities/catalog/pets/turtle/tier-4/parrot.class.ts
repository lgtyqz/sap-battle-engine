...
export class Parrot extends Pet {
  ...
  health = 2;
  initAbilities(): void {
    this.addAbility(new ParrotAbility(this.runtime, this, this.logService, this.petService));
    super.initAbilities();
  }
...
export class ParrotAbility extends Ability {
  ...
  copy(newOwner: Pet): ParrotAbility {
    return new ParrotAbility(this.runtime, newOwner, this.logService, this.petService);
  }
}
