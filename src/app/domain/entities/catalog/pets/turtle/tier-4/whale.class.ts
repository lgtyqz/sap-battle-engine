...
export class Whale extends Pet {
  ...
  initAbilities(): void {
    this.addAbility(
      new WhaleSwallowAbility(this.runtime, this, this.logService, this.petService),
    );
    this.addAbility(
      new WhaleSummonAbility(this.runtime, this, this.logService, this.abilityService),
    );
    super.initAbilities();
  }
...
export class WhaleSummonAbility extends Ability {
  ...
  copy(newOwner: Pet): WhaleSummonAbility {
    return new WhaleSummonAbility(this.runtime,
      newOwner,
      this.logService,
      this.abilityService,
    );
...
export class WhaleSwallowAbility extends Ability {
  ...
  copy(newOwner: Pet): WhaleSwallowAbility {
    return new WhaleSwallowAbility(this.runtime, newOwner, this.logService, this.petService);
  }
}
