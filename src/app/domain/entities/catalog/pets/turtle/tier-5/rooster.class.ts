...
export class Rooster extends Pet {
  ...
  initAbilities(): void {
    this.addAbility(
      new RoosterAbility(this.runtime, this, this.logService, this.abilityService),
    );
    super.initAbilities();
  }
...
export class RoosterAbility extends Ability {
  ...
  private executeAbility(context: AbilityContext): void {
    ...
    for (let i = 0; i < this.level; i++) {
      let chick = new Chick(this.runtime,
        this.logService,
        this.abilityService,
        owner.parent,
        1,
  ...
  copy(newOwner: Pet): RoosterAbility {
    return new RoosterAbility(this.runtime, newOwner, this.logService, this.abilityService);
  }
}
