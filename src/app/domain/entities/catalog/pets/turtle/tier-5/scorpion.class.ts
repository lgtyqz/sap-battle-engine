...
export class Scorpion extends Pet {
  ...
  initAbilities(): void {
    this.addAbility(new ScorpionAbility(this.runtime, this, this.logService));
    super.initAbilities();
  }
...
export class ScorpionAbility extends Ability {
  ...
  private executeAbility(context: AbilityContext): void {
    ...
    let equipment = new Peanut(this.runtime);
  ...
  copy(newOwner: Pet): ScorpionAbility {
    return new ScorpionAbility(this.runtime, newOwner, this.logService);
  }
}
