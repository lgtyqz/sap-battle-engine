...
export class Gibbon extends Pet {
  ...
  initAbilities(): void {
    this.addAbility(
      new GibbonAbility(this.runtime, this, this.logService, this.abilityService),
    );
    super.initAbilities();
  }
...
export class GibbonAbility extends Ability {
  ...
  copy(newOwner: Pet): GibbonAbility {
    return new GibbonAbility(this.runtime, newOwner, this.logService, this.abilityService);
  }
}
