...
export class Bear extends Pet {
  ...
  initAbilities(): void {
    this.addAbility(
      new BearAbility(this.runtime, this, this.logService, this.abilityService),
    );
    super.initAbilities();
  }
...
export class BearAbility extends Ability {
  ...
  private executeAbility(context: AbilityContext): void {
    ...
    for (let target of targets) {
      target.givePetEquipment(new Honey(this.runtime, this.logService, this.abilityService));
  ...
  copy(newOwner: Pet): BearAbility {
    return new BearAbility(this.runtime, newOwner, this.logService, this.abilityService);
  }
}
