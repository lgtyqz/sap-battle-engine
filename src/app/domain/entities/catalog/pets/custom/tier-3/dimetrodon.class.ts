...
export class Dimetrodon extends Pet {
  ...
  override initAbilities(): void {
    this.addAbility(new DimetrodonAbility(this.runtime, this, this.logService));
    super.initAbilities();
  }
...
export class DimetrodonAbility extends Ability {
  ...
  private executeAbility(context: AbilityContext): void {
    ...
    const summoned = new SummonedDimetrodon(this.runtime,
      this.logService,
  ...
  override copy(newOwner: Pet): DimetrodonAbility {
    return new DimetrodonAbility(this.runtime, newOwner, this.logService);
  }
}
