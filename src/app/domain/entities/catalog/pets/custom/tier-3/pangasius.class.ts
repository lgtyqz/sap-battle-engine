...
export class Pangasius extends Pet {
  ...
  override initAbilities(): void {
    this.addAbility(new PangasiusAbility(this.runtime, this, this.logService));
    super.initAbilities();
  }
...
export class PangasiusAbility extends Ability {
  ...
  private executeAbility(context: AbilityContext): void {
    ...
    const sourceEquipment = source?.equipment ?? new Spooked(this.runtime);
  ...
  override copy(newOwner: Pet): PangasiusAbility {
    return new PangasiusAbility(this.runtime, newOwner, this.logService);
  }
}
