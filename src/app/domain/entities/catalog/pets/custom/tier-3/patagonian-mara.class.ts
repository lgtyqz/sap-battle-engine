...
export class PatagonianMara extends Pet {
  ...
  override initAbilities(): void {
    this.addAbility(new PatagonianMaraAbility(this.runtime, this, this.logService));
    super.initAbilities();
  }
...
export class PatagonianMaraAbility extends Ability {
  ...
  private executeAbility(context: AbilityContext): void {
    ...
    const abilityService = this.runtime.services.abilityService;
    const retriever = new GoldenRetriever(this.runtime,
      this.logService,
      abilityService,
      player,
      this.level,
  ...
  override copy(newOwner: Pet): PatagonianMaraAbility {
    return new PatagonianMaraAbility(this.runtime, newOwner, this.logService);
  }
}
