...
export class Slime extends Pet {
  ...
  override initAbilities(): void {
    this.addAbility(new SlimeAbility(this.runtime, this, this.logService, this.abilityService));
    super.initAbilities();
  }
...
export class SlimeAbility extends Ability {
  ...
  constructor(runtime: EngineContext, owner: Pet, logService: LogService, abilityService: AbilityService) {
    super(runtime, {
      name: 'Slime Ability',
      owner: owner,
  ...
  private executeAbility(context: AbilityContext): void {
    ...
    for (let i = 0; i < slimesToSpawn; i++) {
      const slime = new SmallerSlime(this.runtime,
        this.logService,
        this.abilityService,
        owner.parent,
        stats,
  ...
  override copy(newOwner: Pet): SlimeAbility {
    return new SlimeAbility(this.runtime, newOwner, this.logService, this.abilityService);
  }
}
