...
export class Tree extends Pet {
  ...
  override initAbilities(): void {
    this.addAbility(new TreeAbility(this.runtime, this, this.logService));
    super.initAbilities();
  }
...
export class TreeAbility extends Ability {
  ...
  private executeAbility(context: AbilityContext): void {
    ...
    if (owner.attack <= threshold) {
      owner.givePetEquipment(new Coconut(this.runtime));
  ...
  override copy(newOwner: Pet): TreeAbility {
    return new TreeAbility(this.runtime, newOwner, this.logService);
  }
}
