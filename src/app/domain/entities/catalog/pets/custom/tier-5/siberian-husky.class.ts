...
export class SiberianHusky extends Pet {
  ...
  health = 3;
  initAbilities(): void {
    this.addAbility(new SiberianHuskyAbility(this.runtime, this, this.logService));
    super.initAbilities();
  }
...
export class SiberianHuskyAbility extends Ability {
  ...
  private executeAbility(context: AbilityContext): void {
    ...
    this.runtime.random.shuffle(candidates);
  ...
  copy(newOwner: Pet): SiberianHuskyAbility {
    return new SiberianHuskyAbility(this.runtime, newOwner, this.logService);
  }
}
