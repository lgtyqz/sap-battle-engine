...
export class Moose extends Pet {
  ...
  initAbilities(): void {
    this.addAbility(
      new MooseAbility(this.runtime, this, this.logService, this.abilityService),
    );
    super.initAbilities();
  }
...
export class MooseAbility extends Ability {
  ...
  copy(newOwner: Pet): MooseAbility {
    return new MooseAbility(this.runtime, newOwner, this.logService, this.abilityService);
  }
}
