...
export class Boitata extends Pet {
  ...
  initAbilities(): void {
    this.addAbility(
      new BoitataAbility(this.runtime, this, this.logService, this.abilityService),
    );
    super.initAbilities();
  }
...
export class BoitataAbility extends Ability {
  ...
  copy(newOwner: Pet): BoitataAbility {
    return new BoitataAbility(this.runtime, newOwner, this.logService, this.abilityService);
  }
}
