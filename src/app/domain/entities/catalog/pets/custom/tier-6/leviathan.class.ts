...
export class Leviathan extends Pet {
  ...
  initAbilities(): void {
    this.addAbility(
      new LeviathanAbility(this.runtime, this, this.logService, this.petService),
    );
    super.initAbilities();
  }
...
export class LeviathanAbility extends Ability {
  ...
  copy(newOwner: Pet): LeviathanAbility {
    return new LeviathanAbility(this.runtime, newOwner, this.logService, this.petService);
  }
}
