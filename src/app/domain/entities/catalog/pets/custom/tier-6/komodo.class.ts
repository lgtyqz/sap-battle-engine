...
export class Komodo extends Pet {
  ...
  initAbilities(): void {
    this.addAbility(
      new KomodoAbility(this.runtime, this, this.logService, this.abilityService),
    );
    super.initAbilities();
  }
  ...
  shufflePets(start: number, end: number): Pet[] {
    ...
    this.runtime.random.shuffle(pets);
...
export class KomodoAbility extends Ability {
  ...
  copy(newOwner: Pet): KomodoAbility {
    return new KomodoAbility(this.runtime, newOwner, this.logService, this.abilityService);
  }
}
