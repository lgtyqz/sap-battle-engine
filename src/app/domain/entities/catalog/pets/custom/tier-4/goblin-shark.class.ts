...
export class GoblinShark extends Pet {
  ...
  initAbilities(): void {
    this.addAbility(
      new GoblinSharkStartAbility(this.runtime, this, this.logService, this.petService),
    );
    this.addAbility(
      new GoblinSharkFaintAbility(this.runtime, this, this.logService, this.abilityService),
    );
    super.initAbilities();
  }
...
export class GoblinSharkFaintAbility extends Ability {
  ...
  copy(newOwner: Pet): GoblinSharkFaintAbility {
    return new GoblinSharkFaintAbility(this.runtime,
      newOwner,
      this.logService,
      this.abilityService,
    );
...
export class GoblinSharkStartAbility extends Ability {
  ...
  copy(newOwner: Pet): GoblinSharkStartAbility {
    return new GoblinSharkStartAbility(this.runtime,
      newOwner,
      this.logService,
      this.petService,
    );
