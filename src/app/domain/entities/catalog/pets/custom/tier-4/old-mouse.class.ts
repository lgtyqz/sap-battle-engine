...
export class OldMouse extends Pet {
  ...
  initAbilities(): void {
    this.addAbility(
      new OldMouseAbility(this.runtime, this, this.logService, this.abilityService),
    );
    super.initAbilities();
  }
...
export class OldMouseAbility extends Ability {
  ...
  copy(newOwner: Pet): OldMouseAbility {
    return new OldMouseAbility(this.runtime, newOwner, this.logService, this.abilityService);
  }
}
