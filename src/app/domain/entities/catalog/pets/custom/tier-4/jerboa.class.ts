...
export class Jerboa extends Pet {
  ...
  initAbilities(): void {
    this.addAbility(
      new JerboaAbility(this.runtime, this, this.logService, this.abilityService),
    );
    super.initAbilities();
  }
...
export class JerboaAbility extends Ability {
  ...
  copy(newOwner: Pet): JerboaAbility {
    return new JerboaAbility(this.runtime, newOwner, this.logService, this.abilityService);
  }
}
