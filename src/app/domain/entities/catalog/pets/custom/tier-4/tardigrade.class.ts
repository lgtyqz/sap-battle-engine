...
export class Tardigrade extends Pet {
  ...
  initAbilities(): void {
    this.addAbility(
      new TardigradeAbility(this.runtime, this, this.logService, this.abilityService),
    );
    super.initAbilities();
  }
...
export class TardigradeAbility extends Ability {
  ...
  private executeAbility(context: AbilityContext): void {
    ...
    const token = new TardigradeToken(this.runtime,
      this.logService,
      this.abilityService,
      owner.parent,
      tokenStat,
    ...
    if (result.success) {
      token.givePetEquipment(new Dazed(this.runtime));
  ...
  override copy(newOwner: Pet): TardigradeAbility {
    return new TardigradeAbility(this.runtime,
      newOwner,
      this.logService,
      this.abilityService,
    );
