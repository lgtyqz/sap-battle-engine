...
export class Roadrunner extends Pet {
  ...
  override initAbilities(): void {
    this.addAbility(new RoadrunnerAbility(this.runtime, this, this.logService));
    super.initAbilities();
  }
}
...
export class RoadrunnerAbility extends Ability {
  ...
  private executeAbility(context: AbilityContext): void {
    ...
    for (const target of targets) {
      ...
      const strawberry = new Strawberry(this.runtime, this.logService);
      if (strawberry) {
  ...
  override copy(newOwner: Pet): RoadrunnerAbility {
    return new RoadrunnerAbility(this.runtime, newOwner, this.logService);
  }
}
