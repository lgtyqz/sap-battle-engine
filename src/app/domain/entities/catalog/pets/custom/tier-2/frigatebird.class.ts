...
export class Frigatebird extends Pet {
  ...
  initAbilities(): void {
    this.addAbility(new FrigatebirdAbility(this.runtime, this, this.logService));
    super.initAbilities();
  }
...
export class FrigatebirdAbility extends Ability {
  ...
  private executeAbility(context: AbilityContext): void {
    ...
    target.removePerk();
    target.givePetEquipment(new Rice(this.runtime));
  ...
  copy(newOwner: Pet): FrigatebirdAbility {
    return new FrigatebirdAbility(this.runtime, newOwner, this.logService);
  }
}
