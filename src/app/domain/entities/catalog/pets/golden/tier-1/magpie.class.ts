...
export class Magpie extends Pet {
  ...
  initAbilities(): void {
    this.addAbility(
      new MagpieAbility(this.runtime, this, this.logService, this.abilityService),
    );
    super.initAbilities();
  }
...
export class MagpieAbility extends Ability {
  ...
  copy(newOwner: Pet): MagpieAbility {
    return new MagpieAbility(this.runtime, newOwner, this.logService, this.abilityService);
  }
}
