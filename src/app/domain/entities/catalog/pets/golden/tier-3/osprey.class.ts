...
export class Osprey extends Pet {
  ...
  initAbilities(): void {
    this.addAbility(
      new OspreyAbility(this.runtime, this, this.logService, this.abilityService),
    );
    super.initAbilities();
  }
...
export class OspreyAbility extends Ability {
  ...
  private executeAbility(context: AbilityContext): void {
    ...
    for (let i = 0; i < owner.level; i++) {
      let groundhog = new Groundhog(this.runtime,
        this.logService,
        this.abilityService,
        owner.parent,
        null,
  ...
  copy(newOwner: Pet): OspreyAbility {
    return new OspreyAbility(this.runtime, newOwner, this.logService, this.abilityService);
  }
}
