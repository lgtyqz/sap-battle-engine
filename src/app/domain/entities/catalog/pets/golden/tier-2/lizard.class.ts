...
export class Lizard extends Pet {
  ...
  initAbilities(): void {
    this.addAbility(
      new LizardAbility(this.runtime, this, this.logService, this.abilityService),
    );
    super.initAbilities();
  }
...
export class LizardAbility extends Ability {
  ...
  private executeAbility(context: AbilityContext): void {
    ...
    let lizardTail = new LizardTail(this.runtime,
      this.logService,
      this.abilityService,
      owner.parent,
      null,
  ...
  copy(newOwner: Pet): LizardAbility {
    return new LizardAbility(this.runtime, newOwner, this.logService, this.abilityService);
  }
}
