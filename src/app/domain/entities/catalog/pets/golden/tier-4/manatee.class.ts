...
export class Manatee extends Pet {
  ...
  initAbilities(): void {
    this.addAbility(
      new ManateeAbility(this.runtime, this, this.logService, this.abilityService),
    );
    super.initAbilities();
  }
...
export class ManateeAbility extends Ability {
  ...
  copy(newOwner: Pet): ManateeAbility {
    return new ManateeAbility(this.runtime, newOwner, this.logService, this.abilityService);
  }
}
