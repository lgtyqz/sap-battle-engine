...
export class Sealion extends Pet {
  ...
  initAbilities(): void {
    this.addAbility(
      new SealionAbility(this.runtime, this, this.logService, this.abilityService),
    );
    super.initAbilities();
  }
...
export class SealionAbility extends Ability {
  ...
  copy(newOwner: Pet): SealionAbility {
    return new SealionAbility(this.runtime, newOwner, this.logService, this.abilityService);
  }
}
