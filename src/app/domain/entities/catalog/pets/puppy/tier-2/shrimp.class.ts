...
export class Shrimp extends Pet {
  ...
  initAbilities(): void {
    this.addAbility(
      new ShrimpAbility(this.runtime, this, this.logService, this.abilityService),
    );
    super.initAbilities();
  }
...
export class ShrimpAbility extends Ability {
  ...
  copy(newOwner: Pet): ShrimpAbility {
    return new ShrimpAbility(this.runtime, newOwner, this.logService, this.abilityService);
  }
}
