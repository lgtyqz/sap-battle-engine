...
export class Mandrill extends Pet {
  ...
  initAbilities(): void {
    this.addAbility(
      new MandrillAbility(this.runtime, this, this.logService, this.abilityService),
    );
    super.initAbilities();
  }
...
export class MandrillAbility extends Ability {
  ...
  copy(newOwner: Pet): MandrillAbility {
    return new MandrillAbility(this.runtime, newOwner, this.logService, this.abilityService);
  }
}
