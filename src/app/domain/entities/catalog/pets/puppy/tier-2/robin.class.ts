...
export class Robin extends Pet {
  ...
  initAbilities(): void {
    this.addAbility(
      new RobinAbility(this.runtime, this, this.logService, this.abilityService),
    );
    super.initAbilities();
  }
...
export class RobinAbility extends Ability {
  ...
  private executeAbility(context: AbilityContext): void {
    ...
    let nest = new Nest(this.runtime,
      this.logService,
      this.abilityService,
      owner.parent,
      null,
    ...
    if (result.success) {
      ...
      nest.givePetEquipment(new Egg(this.runtime, this.logService));
    }
  ...
  copy(newOwner: Pet): RobinAbility {
    return new RobinAbility(this.runtime, newOwner, this.logService, this.abilityService);
  }
}
