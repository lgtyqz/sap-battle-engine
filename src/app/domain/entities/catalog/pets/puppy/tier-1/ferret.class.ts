...
export class Ferret extends Pet {
  ...
  initAbilities(): void {
    this.addAbility(
      new FerretAbility(this.runtime, this, this.logService, this.abilityService),
    );
    super.initAbilities();
  }
...
export class FerretAbility extends Ability {
  ...
  copy(newOwner: Pet): FerretAbility {
    return new FerretAbility(this.runtime, newOwner, this.logService, this.abilityService);
  }
}
