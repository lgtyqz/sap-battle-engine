...
export class Chinchilla extends Pet {
  ...
  initAbilities(): void {
    this.addAbility(
      new ChinchillaAbility(this.runtime, this, this.logService, this.abilityService),
    );
    super.initAbilities();
  }
...
export class ChinchillaAbility extends Ability {
  ...
  private executeAbility(context: AbilityContext): void {
    ...
    const loyalChinchilla = new LoyalChinchilla(this.runtime,
      this.logService,
      this.abilityService,
      owner.parent,
      power,
  ...
  copy(newOwner: Pet): ChinchillaAbility {
    return new ChinchillaAbility(this.runtime,
      newOwner,
      this.logService,
      this.abilityService,
    );
