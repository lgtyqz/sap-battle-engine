...
export class Sauropod extends Pet {
  ...
  initAbilities(): void {
    this.addAbility(
      new SauropodAbility(this.runtime, this, this.logService, this.abilityService),
    );
    super.initAbilities();
  }
...
export class SauropodAbility extends Ability {
  ...
  copy(newOwner: Pet): SauropodAbility {
    return new SauropodAbility(this.runtime, newOwner, this.logService, this.abilityService);
  }
}
