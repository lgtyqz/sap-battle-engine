...
export class Mongoose extends Pet {
  ...
  initAbilities(): void {
    this.addAbility(
      new MongooseAbility(this.runtime, this, this.logService, this.abilityService),
    );
    super.initAbilities();
  }
...
export class MongooseAbility extends Ability {
  ...
  copy(newOwner: Pet): MongooseAbility {
    return new MongooseAbility(this.runtime, newOwner, this.logService, this.abilityService);
  }
}
