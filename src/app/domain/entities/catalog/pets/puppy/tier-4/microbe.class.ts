...
export class Microbe extends Pet {
  ...
  health = 1;
  initAbilities(): void {
    this.addAbility(new MicrobeAbility(this.runtime, this, this.logService));
    super.initAbilities();
  }
...
export class MicrobeAbility extends Ability {
  ...
  private executeAbility(context: AbilityContext): void {
    ...
    for (let pet of targets) {
      ...
      pet.givePetEquipment(new Weak(this.runtime));
    }
  ...
  copy(newOwner: Pet): MicrobeAbility {
    return new MicrobeAbility(this.runtime, newOwner, this.logService);
  }
}
