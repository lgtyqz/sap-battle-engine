...
export class Tahr extends Pet {
  ...
  initAbilities(): void {
    this.addAbility(
      new TahrAbility(this.runtime, this, this.logService, this.abilityService),
    );
    super.initAbilities();
  }
...
export class TahrAbility extends Ability {
  ...
  private executeAbility(context: AbilityContext): void {
    ...
    for (let pet of targetsBehindResp.pets) {
      ...
      pet.givePetEquipment(new MildChili(this.runtime, this.logService, this.abilityService));
    }
  ...
  copy(newOwner: Pet): TahrAbility {
    return new TahrAbility(this.runtime, newOwner, this.logService, this.abilityService);
  }
}
