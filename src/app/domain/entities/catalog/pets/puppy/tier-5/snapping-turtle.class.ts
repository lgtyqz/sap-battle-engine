...
export class SnappingTurtle extends Pet {
  ...
  health = 5;
  initAbilities(): void {
    this.addAbility(new SnappingTurtleAbility(this.runtime, this, this.logService));
    super.initAbilities();
  }
...
export class SnappingTurtleAbility extends Ability {
  ...
  private executeAbility(context: AbilityContext): void {
    ...
    for (let pet of targetsBehindResp.pets) {
      ...
      pet.givePetEquipment(new Skewer(this.runtime, this.logService));
    }
  ...
  copy(newOwner: Pet): SnappingTurtleAbility {
    return new SnappingTurtleAbility(this.runtime, newOwner, this.logService);
  }
}
