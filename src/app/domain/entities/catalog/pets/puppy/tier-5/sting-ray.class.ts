...
export class StingRay extends Pet {
  ...
  initAbilities(): void {
    this.addAbility(
      new StingRayAbility(this.runtime, this, this.logService, this.abilityService),
    );
    super.initAbilities();
  }
...
export class StingRayAbility extends Ability {
  ...
  copy(newOwner: Pet): StingRayAbility {
    return new StingRayAbility(this.runtime, newOwner, this.logService, this.abilityService);
  }
}
