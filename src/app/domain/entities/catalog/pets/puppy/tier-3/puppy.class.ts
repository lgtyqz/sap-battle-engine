...
export class Puppy extends Pet {
  ...
  initAbilities(): void {
    this.addAbility(
      new PuppyAbility(this.runtime, this, this.logService, this.abilityService),
    );
    super.initAbilities();
  }
...
export class PuppyAbility extends Ability {
  ...
  copy(newOwner: Pet): PuppyAbility {
    return new PuppyAbility(this.runtime, newOwner, this.logService, this.abilityService);
  }
}
