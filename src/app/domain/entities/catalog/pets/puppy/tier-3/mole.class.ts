...
export class Mole extends Pet {
  ...
  initAbilities(): void {
    this.addAbility(
      new MoleAbility(this.runtime, this, this.logService, this.abilityService),
    );
    super.initAbilities();
  }
}
...
export class MoleAbility extends Ability {
  ...
  private executeAbility(context: AbilityContext): void {
    ...
    let mole = new Mole(this.runtime,
      this.logService,
      this.abilityService,
      owner.parent,
      power,
  ...
  copy(newOwner: Pet): MoleAbility {
    return new MoleAbility(this.runtime, newOwner, this.logService, this.abilityService);
  }
}
