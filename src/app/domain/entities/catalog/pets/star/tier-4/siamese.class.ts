...
export class Siamese extends Pet {
  ...
  initAbilities(): void {
    this.addAbility(
      new SiameseAbility(this.runtime, this, this.logService, this.abilityService),
    );
    super.initAbilities();
  }
...
export class SiameseAbility extends Ability {
  ...
  copy(newOwner: Pet): SiameseAbility {
    return new SiameseAbility(this.runtime, newOwner, this.logService, this.abilityService);
  }
}
