...
export class GuineaPig extends Pet {
  ...
  initAbilities(): void {
    this.addAbility(
      new GuineaPigAbility(this.runtime, this, this.logService, this.abilityService),
    );
    super.initAbilities();
  }
...
export class GuineaPigAbility extends Ability {
  ...
  private executeAbility(context: AbilityContext): void {
    ...
    const guineaPig = new GuineaPig(this.runtime,
      this.logService,
      this.abilityService,
      owner.parent,
      power,
  ...
  copy(newOwner: Pet): GuineaPigAbility {
    return new GuineaPigAbility(this.runtime, newOwner, this.logService, this.abilityService);
  }
}
