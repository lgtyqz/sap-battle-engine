...
export class Ostrich extends Pet {
  ...
  initAbilities(): void {
    this.addAbility(
      new OstrichAbility(this.runtime, this, this.logService, this.abilityService),
    );
    super.initAbilities();
  }
...
export class OstrichAbility extends Ability {
  ...
  copy(newOwner: Pet): OstrichAbility {
    return new OstrichAbility(this.runtime, newOwner, this.logService, this.abilityService);
  }
}
