...
export class Okapi extends Pet {
  ...
  health = 3;
  initAbilities(): void {
    this.addAbility(new OkapiAbility(this.runtime, this, this.logService, this.abilityService));
    super.initAbilities();
  }
...
export class OkapiAbility extends Ability {
  ...
  copy(newOwner: Pet): OkapiAbility {
    return new OkapiAbility(this.runtime, newOwner, this.logService, this.abilityService);
  }
}
