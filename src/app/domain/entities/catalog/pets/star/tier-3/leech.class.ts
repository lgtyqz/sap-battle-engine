...
export class Leech extends Pet {
  ...
  health = 3;
  initAbilities(): void {
    this.addAbility(new LeechAbility(this.runtime, this, this.logService, this.abilityService));
    super.initAbilities();
  }
...
export class LeechAbility extends Ability {
  ...
  copy(newOwner: Pet): LeechAbility {
    return new LeechAbility(this.runtime, newOwner, this.logService, this.abilityService);
  }
}
