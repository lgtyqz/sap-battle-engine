...
export class Toad extends Pet {
  ...
  initAbilities(): void {
    this.addAbility(new ToadAbility(this.runtime, this, this.logService));
    super.initAbilities();
  }
...
export class ToadAbility extends Ability {
  ...
  private executeAbility(context: AbilityContext): void {
    ...
    target.givePetEquipment(new Weak(this.runtime));
  ...
  copy(newOwner: Pet): ToadAbility {
    return new ToadAbility(this.runtime, newOwner, this.logService);
  }
}
