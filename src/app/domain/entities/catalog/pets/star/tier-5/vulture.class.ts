...
export class Vulture extends Pet {
  ...
  initAbilities(): void {
    this.addAbility(
      new VultureAbility(this.runtime, this, this.logService, this.abilityService),
    );
    super.initAbilities();
  }
...
export class VultureAbility extends Ability {
  ...
  copy(newOwner: Pet): VultureAbility {
    return new VultureAbility(this.runtime, newOwner, this.logService, this.abilityService);
  }
}
