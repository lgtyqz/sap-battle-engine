...
export class Pelican extends Pet {
  ...
  initAbilities(): void {
    this.addAbility(
      new PelicanStartAbility(this.runtime, this, this.logService, this.petService),
    );
    this.addAbility(
      new PelicanFaintAbility(this.runtime, this, this.logService, this.abilityService),
    );
    super.initAbilities();
  }
...
export class PelicanFaintAbility extends Ability {
  ...
  copy(newOwner: Pet): PelicanFaintAbility {
    return new PelicanFaintAbility(this.runtime,
      newOwner,
      this.logService,
      this.abilityService,
    );
...
export class PelicanStartAbility extends Ability {
  ...
  copy(newOwner: Pet): PelicanStartAbility {
    return new PelicanStartAbility(this.runtime, newOwner, this.logService, this.petService);
  }
}
