...
export class Pheasant extends Pet {
  ...
  initAbilities(): void {
    this.addAbility(
      new PheasantAbility(this.runtime, this, this.logService, this.abilityService),
    );
    super.initAbilities();
  }
...
export class PheasantAbility extends Ability {
  ...
  copy(newOwner: Pet): PheasantAbility {
    return new PheasantAbility(this.runtime, newOwner, this.logService, this.abilityService);
  }
}
