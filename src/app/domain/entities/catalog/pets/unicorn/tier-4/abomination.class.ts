...
export class Abomination extends Pet {
  ...
  initAbilities(): void {
    this.addAbility(
      new AbominationAbility(this.runtime, this, this.logService, this.petService),
    );
    super.initAbilities();
  }
...
export class AbominationAbility extends Ability {
  ...
  copy(newOwner: Pet): AbominationAbility {
    return new AbominationAbility(this.runtime, newOwner, this.logService, this.petService);
  }
}
