...
export class FrostWolf extends Pet {
  ...
  health = 3;
  initAbilities(): void {
    this.addAbility(new FrostWolfAbility(this.runtime, this, this.logService));
    super.initAbilities();
  }
...
export class FrostWolfAbility extends Ability {
  ...
  private executeAbility(context: AbilityContext): void {
    ...
    const coldAilment = new Cold(this.runtime);
  ...
  copy(newOwner: Pet): FrostWolfAbility {
    return new FrostWolfAbility(this.runtime, newOwner, this.logService);
  }
}
