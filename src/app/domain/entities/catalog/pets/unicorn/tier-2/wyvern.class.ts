...
export class Wyvern extends Pet {
  ...
  initAbilities(): void {
    this.addAbility(
      new WyvernAbility(this.runtime, this, this.logService, this.abilityService),
    );
    super.initAbilities();
  }
...
export class WyvernAbility extends Ability {
  ...
  copy(newOwner: Pet): WyvernAbility {
    return new WyvernAbility(this.runtime, newOwner, this.logService, this.abilityService);
  }
}
