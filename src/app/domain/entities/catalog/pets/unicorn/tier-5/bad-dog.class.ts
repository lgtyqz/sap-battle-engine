...
export class BadDog extends Pet {
  ...
  initAbilities(): void {
    this.addAbility(
      new BadDogAbility(this.runtime, this, this.logService, this.abilityService),
    );
    super.initAbilities();
  }
...
export class BadDogAbility extends Ability {
  ...
  copy(newOwner: Pet): BadDogAbility {
    return new BadDogAbility(this.runtime, newOwner, this.logService, this.abilityService);
  }
}
