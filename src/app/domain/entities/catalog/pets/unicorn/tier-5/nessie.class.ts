...
export class Nessie extends Pet {
  ...
  initAbilities(): void {
    this.addAbility(
      new NessieAbility(this.runtime, this, this.logService, this.abilityService),
    );
    super.initAbilities();
  }
...
export class NessieAbility extends Ability {
  ...
  private executeAbility(context: AbilityContext): void {
    ...
    let nessieQ = new NessieQ(this.runtime,
      this.logService,
      this.abilityService,
      owner.parent,
      health,
  ...
  copy(newOwner: Pet): NessieAbility {
    return new NessieAbility(this.runtime, newOwner, this.logService, this.abilityService);
  }
}
