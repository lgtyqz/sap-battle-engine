...
export class SalmonOfKnowledge extends Pet {
  ...
  health = 5;
  initAbilities(): void {
    this.addAbility(new SalmonOfKnowledgeAbility(this.runtime, this, this.logService));
    super.initAbilities();
  }
...
export class SalmonOfKnowledgeAbility extends Ability {
  ...
  copy(newOwner: Pet): SalmonOfKnowledgeAbility {
    return new SalmonOfKnowledgeAbility(this.runtime, newOwner, this.logService);
  }
}
