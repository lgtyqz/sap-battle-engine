...
export class Amalgamation extends Pet {
  ...
  health = 5;
  initAbilities(): void {
    this.addAbility(new AmalgamationAbility(this.runtime, this, this.logService));
    super.initAbilities();
  }
...
export class AmalgamationAbility extends Ability {
  ...
  private executeAbility(context: AbilityContext): void {
    ...
    target.givePetEquipment(new Spooked(this.runtime));
  ...
  copy(newOwner: Pet): AmalgamationAbility {
    return new AmalgamationAbility(this.runtime, newOwner, this.logService);
  }
}
