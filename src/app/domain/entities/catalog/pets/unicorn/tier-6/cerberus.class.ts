...
export class Cerberus extends Pet {
  ...
  initAbilities(): void {
    this.addAbility(
      new CerberusAbility(this.runtime, this, this.logService, this.abilityService),
    );
    super.initAbilities();
  }
...
export class CerberusAbility extends Ability {
  ...
  private executeAbility(context: AbilityContext): void {
    ...
    let exp = 5;
    let firePup = new FirePup(this.runtime,
      this.logService,
      this.abilityService,
      owner.parent,
      8,
  ...
  copy(newOwner: Pet): CerberusAbility {
    return new CerberusAbility(this.runtime, newOwner, this.logService, this.abilityService);
  }
}
