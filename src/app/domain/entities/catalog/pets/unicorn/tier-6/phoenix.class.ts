...
export class Phoenix extends Pet {
  ...
  health = 8;
  initAbilities(): void {
    this.addAbility(new PhoenixFaintAbility(this.runtime, this, this.logService));
    this.addAbility(
      new PhoenixAfterFaintAbility(this.runtime, this, this.logService, this.abilityService),
    );
    super.initAbilities();
  }
...
export class PhoenixAfterFaintAbility extends Ability {
  ...
  private executeAbility(context: AbilityContext): void {
    ...
    let youngPhoenix = new YoungPhoenix(this.runtime,
      this.logService,
      this.abilityService,
      owner.parent,
      power,
  ...
  copy(newOwner: Pet): PhoenixAfterFaintAbility {
    return new PhoenixAfterFaintAbility(this.runtime,
      newOwner,
      this.logService,
      this.abilityService,
    );
...
export class PhoenixFaintAbility extends Ability {
  ...
  copy(newOwner: Pet): PhoenixFaintAbility {
    return new PhoenixFaintAbility(this.runtime, newOwner, this.logService);
  }
}
