...
export class FurBearingTrout extends Pet {
  ...
  health = 5;
  initAbilities(): void {
    this.addAbility(new FurBearingTroutAbility(this.runtime, this, this.logService));
    super.initAbilities();
  }
...
export class FurBearingTroutAbility extends Ability {
  ...
  private executeAbility(context: AbilityContext): void {
    ...
    for (let target of targets) {
      ...
      target.givePetEquipment(new Rambutan(this.runtime, this.logService));
    }
  ...
  copy(newOwner: Pet): FurBearingTroutAbility {
    return new FurBearingTroutAbility(this.runtime, newOwner, this.logService);
  }
}
