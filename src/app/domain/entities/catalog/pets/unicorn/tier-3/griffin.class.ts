...
export class Griffin extends Pet {
  ...
  initAbilities(): void {
    this.addAbility(
      new GriffinAbility(this.runtime, this, this.logService, this.abilityService),
    );
    super.initAbilities();
  }
...
export class GriffinAbility extends Ability {
  ...
  copy(newOwner: Pet): GriffinAbility {
    return new GriffinAbility(this.runtime, newOwner, this.logService, this.abilityService);
  }
}
