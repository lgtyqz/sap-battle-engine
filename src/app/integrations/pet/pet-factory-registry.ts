...
export const SPECIAL_FORM_PET_BUILDERS: Record<string, SpecialFormPetBuilder> =
{
  'Beluga Whale': (deps, petForm, parent, petService) => {
    return new BelugaWhale(deps.logService.runtime,
      deps.logService,
      deps.abilityService,
      petService,
      parent,
  ...
  Abomination: (deps, petForm, parent, petService) => {
    return new Abomination(deps.logService.runtime,
      deps.logService,
      deps.abilityService,
      petService,
      parent,
  ...
  'Sabertooth Tiger': (deps, petForm, parent, petService) => {
    return new SabertoothTiger(deps.logService.runtime,
      deps.logService,
      deps.abilityService,
      petService,
      parent,
  ...
  Tuna: (deps, petForm, parent) => {
    return new Tuna(deps.logService.runtime,
      deps.logService,
      deps.abilityService,
      parent,
      petForm.health,
  ...
  Slime: (deps, petForm, parent) => {
    return new Slime(deps.logService.runtime,
      deps.logService,
      deps.abilityService,
      parent,
      petForm.health,
