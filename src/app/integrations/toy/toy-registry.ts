...
type StandardToyConstructor = new (runtime: EngineContext,
  logService: LogService,
  toyService: ToyRuntimeService,
  parent: Player,
  level: number,
...
type AbilityServiceToyConstructor = new (runtime: EngineContext,
  logService: LogService,
  toyService: ToyRuntimeService,
  abilityService: AbilityService,
  parent: Player,
...
export const SPECIAL_TOY_BUILDERS: {
  ...
  'Rubber Duck': (deps) =>
    new RubberDuck(deps.logService.runtime,
      deps.logService,
      deps.toyService,
      deps.petService,
      deps.parent,
  ...
  'Stick': (deps) =>
    new Stick(deps.logService.runtime,
      deps.logService,
      deps.toyService,
      deps.parent,
      deps.level,
  ...
  'Stuffed Bear': (deps) =>
    new StuffedBear(deps.logService.runtime,
      deps.logService,
      deps.toyService,
      deps.petService,
      deps.parent,
  ...
  'Pandoras Box': (deps) =>
    new PandorasBox(deps.logService.runtime,
      deps.logService,
      deps.toyService,
      deps.parent,
      deps.level,
  ...
  'Microwave Oven': (deps) =>
    new MicrowaveOven(deps.logService.runtime,
      deps.logService,
      deps.toyService,
      deps.parent,
      deps.level,
  ...
  'Cash Register': (deps) =>
    new CashRegister(deps.logService.runtime,
      deps.logService,
      deps.toyService,
      deps.petService!,
      deps.parent,
